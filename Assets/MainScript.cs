...
//			go.transform.position+=new Vector3(100f,-190f,0f);
	...
	void Update () {
		...
		{
			hostScore.transform.localPosition+=new Vector3(50f,-206f,0f);
		}
		if(clientScore&&clientScore.transform.position.x==0)
		{
			clientScore.transform.localPosition+=new Vector3(50f,-229f,0f);
		}

		if (fsm!=null&&fsm.FsmVariables.GetFsmBool ("GameOver").Value == true)
		{
